...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
    <span class="navbar-brand">Tahir Uzelli</span>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item px-3">
          <a class="nav-link" href="iletişim.html">Bana Yazın</a>
        </li>
        <li class="nav-item px-3">
  ...
  <title>Tahir Uzelli Kişisel Web Sitesi</title>
</head>
<body>
    ...
    <div class="banaulasin">
      <div class="container">
        ...
        <div class="social-icons">
         <a href="https://github.com/tahiruzelli" class="github"><i class="fa fa-github"></i></a>
							<a href="https://www.instagram.com/tahiruzelli/" class="instagram"><i class="fa fa-instagram"></i></a>
							<a href="https://www.facebook.com/tahir.uzelli.7" class="facebook"><i class="fa fa-facebook"></i></a>
        </div>
      </div>
    </div>
  </footer>
